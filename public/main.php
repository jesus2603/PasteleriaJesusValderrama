<?php
        ...
        <div class='container mt-4'>
            <h1 class='text-center mb-4 header'>¡Bienvenido a la mejor pastelería del mundo!</h1>
                        ...
                        <div class='card'>
                            ...
                            <div class='card-body'>
                                ...
                                <form method='post' action='carrito.php'>
                                    ...
                                    <input type='hidden' name='nombre' value='{$pastel['nombre']}'>
                                    <input type='hidden' name='precio' value='{$pastel['precio']}'>
